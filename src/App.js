			...
			<Router>
				...
				<Routes>
					...
					<Route
						...
						element={role === "ROLE_PATIENT" ? <PatientAccountDetails token={token} profiles={profiles} /> : <Navigate to="/" />}
					/>

					{/* Doctor */}
					<Route
						path="/doctor-account-details"
						element={role === "ROLE_DOCTOR" ? <DoctorAccountDetails token={token} profiles={profiles} /> : <Navigate to="/" />}
					/>
					<Route
						path="/doctor-appointments"
						element={role === "ROLE_DOCTOR" ? <DoctorAppointments appointments={appointments} /> : <Navigate to="/" />}
					/>
					<Route
					...
					<Route
						...
						element={role === "ROLE_ADMIN" ? <AdminAccountDetails token={token} profiles={profiles} /> : <Navigate to="/" />}
					/>
					...
					<Route path="/admin-schedules" element={role === "ROLE_ADMIN" ? <AdminSchedules appointments={appointmentsAll} /> : <Navigate to="/" />} />
