...
export default function PatientAccountDetails({ token, profiles }) {
	...
	return (
		<div className="patientAccountDetails container top">
			<h1>My Profile - Patient</h1>
			{isEdit ? (
				<div className="row">
					<div className="col text-center">
						<img src="/assets/patient/patient.png" alt="" className="mb-5 imgPatientProfile" />
					</div>
					<div className="col">
